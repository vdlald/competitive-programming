...
void solve() {
    ...
    auto first_team = m.begin();
    auto second_team = m.begin();
    second_team++;
    if (first_team->second.value > second_team->second.value) {
        cout << first_team->first;
    } else {
        cout << second_team->first;
    }
}
